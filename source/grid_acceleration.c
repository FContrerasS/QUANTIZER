...
static void computing_grid_acceleration_branch(struct node *ptr_node)
{
    ...
    for (int i = 0; i < ptr_node->grid_bder_size; i++)
    {
        ...
        pt_box_grid_idx_1 = pt_box_idx_1_x + pt_box_idx_1_y * grid_box_real_dim_X_pt + pt_box_idx_1_z * grid_box_real_dim_X_times_Y_pt;

        //** x-axis acceleration **/
        pt_box_grid_idx_2 = pt_box_idx_2_x + pt_box_idx_1_y * grid_box_real_dim_X_pt + pt_box_idx_1_z * grid_box_real_dim_X_times_Y_pt;
        ...
        //** y-axis acceleration **/
        pt_box_grid_idx_2 = pt_box_idx_1_x + pt_box_idx_2_y * grid_box_real_dim_X_pt + pt_box_idx_1_z * grid_box_real_dim_X_times_Y_pt;
        ...
        //** z-axis acceleration **/
        pt_box_grid_idx_2 = pt_box_idx_1_x + pt_box_idx_1_y * grid_box_real_dim_X_pt + pt_box_idx_2_z * grid_box_real_dim_X_times_Y_pt;
